                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu" style="display: none;">
                            <li>
                                <a href="<?php echo base_url('operator/masuk/') ?>">
                                    <i class="fa fa-book"></i> <span>SURAT MASUK</span>
                                </a>
                            </li>
                            <li>
                                <a href="<?php echo base_url('operator/keluar/') ?>">
                    ...
                    <li>
                        <a href="<?php echo base_url('operator/doklain/') ?>">
                            <i class="fa fa-align-justify"></i> <span>DOKUMEN LAIN</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('operator/grafik_surat/') ?>">
                    ...
                    <li>
                        <a href="<?php echo base_url('operator/naskah/') ?>">
                            <i class="fa fa-folder"></i> <span>NASKAH SURAT</span>
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo base_url('operator/pass/') ?>">
