        ...
        <section class="col-lg-12">
            <div class="box box-info">
                <div class="box-header">
                    <center>
                        <h3 style="text-transform:uppercase">&nbsp <strong>GRAFIK SURAT <br /><?php echo $pts->pts_nama; ?></strong></h3>
                    </center>
                </div>
                <div class="box-body">
                    <div class="container">
                                ...
                                datasets: [{
                                    ...
                                    data: [
                                        ...
                                        foreach ($jad as $d) {
                                            ...
                                            $w = $this->db->query("SELECT * FROM arsip WHERE arsip_kategori='$id_jad'")->num_rows();
