            ...
            <section class="col-lg-8 col-lg-offset-2">
                <div class="box box-info">
                    <div class="box-header">
                        <a href="<?php echo base_url('surat/doklain') ?>" class="btn btn-warning btn-sm pull-right"><i class="fa fa-reply"></i> &nbsp; Kembali</a>
                    </div>
                    <div class="box-body">
                        <form method="post" action="<?php echo base_url() . 'surat/proses_doklain_edit/' . $d->arsip_id ?>" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select name="user" class="form-control" required="required">
                                    ...
                                    foreach ($user as $w) {
                                    ?>
                                        <option <?php if ($w->user_id == $d->arsip_user) {
                                                    echo "selected='selected'";
