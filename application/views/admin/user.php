                ...
                <div class="box-header">
                    <?php if (isset($_SESSION['error'])) { ?>
                        ...
                        <div class="alert alert-success alert-dismissible fade in">
                            <i class="fa fa-warning"></i> &nbsp;USERNAME YANG ANDA INPUT SUDAH ADA DI DATABASE. <strong><?php echo $_SESSION['error'] ?></strong>
                    ...
                    ?>
                    <a href="<?php echo base_url('surat/usertambah/') ?>" class="btn btn-warning btn-sm pull-right"><i class="fa fa-plus"></i> &nbsp TAMBAH DATA PENGGUNA</a>
                </div>
                <div class="box-body">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-warning btn-sm" href="<?php echo base_url() . 'surat/user_edit/' . $d->user_id ?>"><i class="fa fa-edit"></i></a>
                                            <?php if ($d->user_id != 1) { ?>
                                                <!-- <a class='btn btn-danger btn-sm' data-toggle='modal' data-target='#konfirmasi_hapus' data-href="<?php echo base_url() . 'surat/user_hapus/' . $d->user_id ?>"><i class='fa fa-trash'></i></a> -->
                                                <?php echo "<a class='btn btn-danger btn-sm' data-toggle='modal' data-target='#konfirmasi_hapus' data-href='" . base_url() . 'surat/hapus_user/' . $d->user_id . "'><i class='fa fa-trash'></i></a>"; ?>
                                            <?php } ?>
                                        </td>
                                    </tr>
                                <?php
