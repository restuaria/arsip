        ...
        <section class="col-lg-8 col-lg-offset-2">
            <div class="box box-info">
                <div class="box-header">
                    <a href="<?php echo base_url('surat/keluar') ?>" class="btn btn-warning btn-sm pull-right"><i class="fa fa-reply"></i> &nbsp; Kembali</a>
                </div>
                <div class="box-body">
                    <form method="post" action="<?php echo base_url() . 'surat/proses_keluar_edit/' . $me->arsip_id ?>" enctype="multipart/form-data">
