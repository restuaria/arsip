...
<body>
    ...
    <table border="1">
        ...
        <?php
        $no = 1;
        $arsip = $this->db->query("SELECT * FROM arsip,user,kategori WHERE arsip_user=user_id and arsip_kategori=kategori_id and  arsip_kategori='2' ORDER BY arsip_id DESC")->result();
        foreach ($arsip as $p) {
        ?>
            <tr>
