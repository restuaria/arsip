 ...
 <body>
     ...
     <center>
         ...
         <h3 style="text-transform:uppercase"><strong>SEBARAN SURAT KELUAR<br /><?php echo $pts->pts_nama; ?></strong></h3>
     </center>
     ...
     <div class="box-body">
         ...
         <?php
            $no = 1;
            $arsip = $this->db->query("SELECT user.user_nama, COUNT(arsip.arsip_user) AS jumlah FROM user LEFT JOIN arsip ON (arsip.arsip_user= user.user_id) where   arsip_kategori='3' GROUP BY user_nama")->result();
            ?>
