            ...
            <div class="box box-info">
                <div class="box-header">
                    ...
                    <div class="btn-group pull-right">
                        <a href="<?php echo base_url('operator/doklain_tambah/') ?>" class="btn btn-primary btn-sm mb-3 float-right"><i class="fa fa-plus"></i> TAMBAH DATA</a>
                        <a href="<?php echo base_url('operator/doklain_export_pdf/') ?>" target="_blank" class="btn btn-sm btn-warning"><i class="fa fa-file-pdf-o"></i> &nbsp CETAK PDF</a>
                        <a href="<?php echo base_url('operator/doklain_export/') ?>" target="_blank" class="btn btn-sm btn-danger"><i class="fa fa-file-pdf-o"></i> &nbsp EXPORT EXCEL</a>
                    </div>
                </div>
                <div class="box-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="<?php echo base_url() . 'operator/hapus_doklain/' . $p->arsip_id ?>" class="btn btn-warning">Hapus</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="btn-group">
                                            ...
                                            <a href="<?php echo base_url() . 'operator/doklain_edit/' . $p->arsip_id ?>" class="btn btn-warning"><i class="fa fa-edit"></i></a>
