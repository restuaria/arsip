...
<body>
    ...
    <table border="1">
        ...
        $arsip = $this->db->query("SELECT * FROM arsip,user,kategori where arsip_user='$id_user' and arsip_user=user_id and arsip_kategori=kategori_id and  arsip_kategori='3' ORDER BY arsip_id DESC");
