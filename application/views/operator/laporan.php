                                  ...
                                  <table class="table table-bordered table-striped" id="table-datatable">
                                      ...
                                      <tbody>
                                          <?php
                                            ...
                                            $arsip = $this->db->query("SELECT * FROM arsip,user,kategori WHERE arsip_user='$id_user' and arsip_user=user_id and  arsip_kategori='2' and arsip_kategori=kategori_id and date(arsip_tanggal)>='$tgl_dari' and date(arsip_tanggal)<='$tgl_sampai' ORDER BY arsip_tanggal DESC")->result();
                                            foreach ($arsip as $p) {
                                            ?>
                                              <tr>
                                  ...
                                  <table class="table table-bordered table-striped" id="table-datatable">
                                      ...
                                      <tbody>
                                          <?php
                                            $no = 1;
                                            $id_user = $this->session->userdata('user_id');
                                            $arsip = $this->db->query("SELECT * FROM arsip,user,kategori WHERE arsip_user='$id_user' and arsip_user=user_id and  arsip_kategori='3' and arsip_kategori=kategori_id and date(arsip_tanggal)>='$tgl_dari' and date(arsip_tanggal)<='$tgl_sampai' ORDER BY arsip_tanggal DESC")->result();
                                            foreach ($arsip as $p) {
                                            ?>
                                              <tr>
                                                  <td style="text-align:center"><?php echo $no++; ?></td>
